...
function avviaPartita() {
  const secondiHtml = document.querySelector('.timer_secondi');
  const minutiHtml = document.querySelector('.timer_minuti');
...
(function () {
  ...
  // Popola classifica
  const classificaContainer = document.querySelector('.classifica_container');
  const classifica = JSON.parse(localStorage.getItem('classifica')) || [];
